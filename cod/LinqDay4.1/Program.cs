...
namespace cod
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            System.Console.WriteLine("Клиенты с заказами: Inner Join");

            foreach (var Order in inner)
            {
                System.Console.WriteLine($"Заказчик: {Order.ClientName}, заказал: {Order.Product}");
            }
        }
    }
}